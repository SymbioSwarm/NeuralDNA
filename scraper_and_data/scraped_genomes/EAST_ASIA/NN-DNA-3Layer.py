...
weights_level1 = 2*np.random.random((39, 21)) -1
weights_level2 = 2*np.random.random((21,1)) - 1
...
for iterator in xrange(1000):
	...
	print "prediction: ", prediction_layer3
	prediction_layer3_error = truth - prediction_layer3 
	#print error
	#print "error: ",error
	...
	weights_level1 += np.dot(prediction_layer1.T, layer2_delta)
	weights_level2 += np.dot(prediction_layer2.T, layer3_delta)
	print iterator
	#print weights
